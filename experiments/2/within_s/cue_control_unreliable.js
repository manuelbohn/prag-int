...
var testCond = shuffle([
    ...
    "lookLabel",
    "lookLabel"]);
var cond = shuffle(["reliable","reliable","reliable","reliable","unreliable","unreliable","unreliable","unreliable"]);
...
var relFruit = ["car","duck","bear","ball"]

var relTex = ["Car","Duck","Bear","Ball"]

var unrelFruit = ["car","duck","bear","ball"]

var unrelTex = ["Ball","Bear","Duck","Car"]
...
var testControl = shuffle(["no","no","no","bar","bar","bar","abs","abs"]);
...
// moving on within a trial
  ...
  // after exposure is finished, switch to choice      
    ...
    if (experiment.agentOrient[0][0] == "hello") { 
    
        showAgent(agents[0],"straight"); 
    
        $("#text").text("Hello, I'm "+agents[0]); 
        
if (experiment.cond[0] == "reliable"){
          
        sourceRightFruit("images/"+relFruit[0]+".png");
        showRightFruit(); 
        sourceRightFruit2("images/empty.png");
        showRightFruit2(); 
        sourceLeftFruit("images/empty.png");
        ...
        sourceRightFruit("images/"+unrelFruit[0]+".png");
        showRightFruit(); 
        sourceRightFruit2("images/empty.png");
        showRightFruit2(); 
        sourceLeftFruit("images/empty.png");
...
} else if (experiment.agentOrient[0][0] == "rel1") { 
    ...
    if (experiment.cond[0] == "reliable"){
        ...
        $("#text").text("This is a "+relTex[0]);  
        
        experiment.relFruit.shift();
        experiment.relTex.shift();
        ...
        $("#text").text("This is a "+unrelTex[0]); 
            
        experiment.unrelFruit.shift();
        experiment.unrelTex.shift();    
            
        }
    
    
} else if (experiment.agentOrient[0][0] == "rel2") { 
     ...
     showAgent(agents[0],"point_l"); 
        ...
        sourceRightFruit2("images/empty.png");
        showRightFruit2(); 
        sourceLeftFruit("images/"+relFruit[0]+".png");
        showLeftFruit(); 
        sourceLeftFruit2("images/empty.png");
        showLeftFruit2(); 
        ...
        sourceRightFruit2("images/empty.png");
        showRightFruit2(); 
        sourceLeftFruit("images/"+unrelFruit[0]+".png");
        showLeftFruit(); 
        sourceLeftFruit2("images/empty.png");
        showLeftFruit2(); 
        $("#text").text("This is a "+unrelTex[0]); 
...
} else if (experiment.agentOrient[0][0] == "straight") { 
